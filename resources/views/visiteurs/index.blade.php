				...
				<div class="col-md-12">
					<form action="#">
                        ...
                        <div class="row">
                            ...
                            <div class="col-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" placeholder="Titre de reunuent" id="name">
                                </div>
                            </div>
                        </div>
                        {{-- End Row --}}
                        ...
                        <div class="row">
                            ...
                            <div class="col-4">
                                <div class="form-group">
                                    ...
                                    <input type="time" class="form-control" placeholder="Name" id="name">
                                </div>
                            </div>
                            <div class="col-4">
                                <div class="form-group">
                                    <label for="name" class="sr-only">Durée</label>
                                    <input type="text" class="form-control" placeholder="Durée" id="name">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
							...
							<input type="file" class="form-control" name="file" placeholder="file" id="file">
						</div>
